...
public class User implements Serializable {
    ...
    // Registration
    public User(UserName userName, String mobileNumber, String email, String password) {
    ...
    public User(UserName userName, String mobileNumber, String email, String password, long createdDate, UserType userType, Boolean adminApprovalStatus, Boolean enabled, Company userCompany, College userCollege, List<JobPost> companyUserJobPost, List<JobPost> collegeUserJobPost) {
        this.userName = userName;
        this.mobileNumber = mobileNumber;
        this.email = email;
        this.password = password;
