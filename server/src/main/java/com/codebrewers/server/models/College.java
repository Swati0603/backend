...
public class College {
    ...
    public College(String collegeName, int collegeNirfRanking, boolean collegeAicteAffiliation, String collegeWebsite, String collegeEmail, Location collegeLocation, List<User> users) {
    ...
    //The @JsonManagedReference is used on the OneToMany side while the @JsonBackReference is used at the @ManyToOne side.
